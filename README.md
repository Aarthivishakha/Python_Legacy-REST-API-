# Legacy REST API / Microservice (Python 3.10)

A framework-free JSON microservice built on the Python 3.10 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.10 and isolated analyzer jobs.
