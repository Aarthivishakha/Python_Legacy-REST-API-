# Legacy REST API / Microservice (Python 3.8)

A framework-free JSON microservice built on the Python 3.8 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.8 and isolated analyzer jobs.
