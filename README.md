# Legacy REST API / Microservice (Python 3.15 pre-release)

A framework-free JSON microservice built on the Python 3.15 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.15 and isolated analyzer jobs.

Current analyzers run separately under Python 3.10+; application source remains
compatible with Python 3.15.

Python 3.15 remains pre-release. Native CI pins `3.15.0-beta.4`, Docker uses
the official rolling `python:3.15-rc-slim` image, and analyzer execution stays
isolated on Python 3.10+.
