# Legacy REST API / Microservice (Python 3.12)

A framework-free JSON microservice built on the Python 3.12 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.12 and isolated analyzer jobs.
