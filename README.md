# Legacy REST API / Microservice (Python 3.13)

A framework-free JSON microservice built on the Python 3.13 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.13 and isolated analyzer jobs.
