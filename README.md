# Legacy REST API / Microservice (Python 3.9)

A framework-free JSON microservice built on the Python 3.9 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.9 and isolated analyzer jobs.
