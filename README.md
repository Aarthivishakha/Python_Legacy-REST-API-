# Legacy REST API / Microservice (Python 3.14)

A framework-free JSON microservice built on the Python 3.14 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.14 and isolated analyzer jobs.
