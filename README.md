# Legacy REST API / Microservice (Python 3.11)

A framework-free JSON microservice built on the Python 3.11 WSGI standard
...
- `.github/workflows/ci.yml`: native Python 3.11 and isolated analyzer jobs.
